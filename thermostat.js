...
function changeTemperature(roomTemperature, setTemperature) {
    ...
    if(roomTemperature!==setTemperature){
        if(roomTemperature<setTemperature){
            roomTemperature= increaseTemperature(roomTemperature);
        }
        else{
            roomTemperature= decreaseTemperature(roomTemperature);
        }
...
export function changeSetTemperature(isIncrease) {
    ...
    if (isPanelOn()) {
        ...
        //your code here
        if(isIncrease==true){
            setTemperature=currentTemperature+ increaseSetTemperature(setTemperature);
            console.log(setTemperature);
        }
        else{
             setTemperature=currentTemperature+ decreaseSetTemperature(setTemperature);
        }
